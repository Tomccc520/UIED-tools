        ...
        <div class="text-center mb-8 relative">
          <h2 class="text-4xl font-bold mb-3 relative inline-flex flex-col items-center">
            <div class="relative px-12">
              <span class="text-gray-800 hover:text-gray-600 transition-colors duration-300">Excel转CSV</span>
            </div>
          </h2>
          <p class="text-gray-500 text-sm mt-6">在线将Excel文件转换为CSV格式，支持.xlsx, .xls格式，本地处理更安全。</p>
        </div>
...
const guideSteps = [
  ...
  { title: '预览数据', description: '系统将自动解析文件并显示前10行数据供您确认内容是否正确。' },
  { title: '下载CSV', description: '确认无误后，点击“下载CSV”按钮，文件将转换为CSV格式并下载到本地。' }
]

const guideNotes = [
  '默认只转换第一个工作表（Sheet）的内容。',
  '转换过程完全在本地进行，不会消耗您的流量，也不会上传文件。',
  '如果文件较大，处理时间可能会稍长，请耐心等待。'
]
