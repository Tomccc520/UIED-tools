        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div class="lg:col-span-4 space-y-6">
            <div class="bg-gray-50 rounded-xl p-6 border border-gray-100 sticky top-4">
              ...
              <div class="space-y-5">
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2">书籍名称 <span
                      class="text-red-500">*</span></label>
                  <el-input v-model="form.bookName" placeholder="请输入书籍名称" size="large" clearable class="custom-input" />
                </div>

                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2">作者 (可选)</label>
                  <el-input v-model="form.author" placeholder="请输入书籍作者" size="large" clearable
                    class="custom-input" />
                </div>

                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2">核心章节/关注点 (可选)</label>
                  <el-input v-model="form.content" type="textarea" :rows="3" placeholder="请输入您关注的章节或核心内容，帮助AI更精准地写作" class="custom-input" />
                </div>
                ...
                <div>
                  ...
                  <el-select v-model="form.style" placeholder="选择写作风格" class="w-full" size="large">
                    <el-option label="感悟深刻" value="insightful" />
                    <el-option label="客观分析" value="analytical" />
                ...
                <div class="pt-4">
                  <button @click="generateArticle" :disabled="isGenerating || !form.bookName"
...
书籍名称：《${form.bookName}》
${form.author ? `作者：${form.author}` : ''}
${form.content ? `核心关注点：${form.content}` : ''}
写作风格：${getStyleLabel(form.style)}
篇幅长度：约${form.length}字

要求：
1. 深入解读原著，观点独到，有真情实感
2. 结构清晰，包含内容概括、核心感悟、精彩摘录和现实思考
