...
import { buildPerlerPath, perlerStorageKeys } from '../lib/runtime';
...
export default function Home() {
  ...
  useEffect(() => {
    ...
    setIsCustomPalette(true);
        ...
        localStorage.removeItem(perlerStorageKeys.paletteSelections);
        const allHexValues = fullBeadPalette.map(color => color.hex.toUpperCase());
  ...
  const handleProceedToFocusMode = () => {
    ...
    localStorage.setItem(perlerStorageKeys.focusPixelData, JSON.stringify(mappedPixelData));
    localStorage.setItem(perlerStorageKeys.focusGridDimensions, JSON.stringify(gridDimensions));
    localStorage.setItem(perlerStorageKeys.focusColorCounts, JSON.stringify(colorCounts));
    localStorage.setItem(perlerStorageKeys.focusColorSystem, selectedColorSystem);

    // 跳转到专心拼豆页面
    window.location.href = buildPerlerPath('/focus');
  };
  ...
  return (
    ...
    <div className="perler-page p-4 sm:p-6 flex flex-col items-center bg-gradient-to-b from-gray-50 to-white dark:from-gray-800 dark:to-gray-900 font-[family-name:var(--font-geist-sans)] overflow-x-hidden">
      {/* Apply dark mode styles to the header */}
      <header className="perler-hero w-full md:max-w-4xl text-center mt-6 mb-8 sm:mt-8 sm:mb-10 relative overflow-hidden">
          ...
          <div className="relative flex flex-col items-center">
            ...
            <div className="relative flex flex-col items-center space-y-3">
              ...
              <div className="relative">
                <h1 className="relative text-4xl sm:text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 via-indigo-600 to-violet-500 tracking-wide">
                  拼豆图纸生成器
                </h1>
              ...
              {/* 开源工具原始英文名称 */}
              <div className="relative">
                <h2 className="relative text-xl sm:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 via-blue-600 to-cyan-500 tracking-wide">
      ...
      <footer className="w-full md:max-w-4xl mt-10 mb-6 py-6 text-center text-xs sm:text-sm text-gray-500 dark:text-gray-400 border-t border-gray-200 dark:border-gray-700">
