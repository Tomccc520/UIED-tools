        ...
        <div v-else class="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          <div class="lg:col-span-4 space-y-6">
            <div class="bg-gray-50 rounded-xl p-6 border border-gray-100 sticky top-4">
              ...
              <div class="space-y-6">
                <!-- File Info -->
                <div v-if="videoFile" class="bg-white rounded-xl p-4 border border-gray-200 shadow-sm">
            ...
            <div class="bg-white rounded-xl border border-gray-200 overflow-hidden shadow-sm">
              <div class="p-4 border-b border-gray-100 flex justify-between items-center bg-gray-50/50">
                <div class="flex items-center space-x-3">
                  ...
                  <h3 class="font-medium text-gray-700">视频预览</h3>
                </div>
              </div>
        ...
        <div class="bg-gray-50 rounded-xl p-6 border border-gray-100 mt-12">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm text-gray-600">
            <div class="flex items-start">
              ...
              <div>
                <h4 class="font-medium text-gray-800 mb-1">上传视频</h4>
                <p>点击上传或拖拽视频文件到页面中。支持 MP4, WebM 等常见格式。</p>
              </div>
            </div>
            <div class="flex items-start">
              ...
              <div>
                <h4 class="font-medium text-gray-800 mb-1">一键静音</h4>
                <p>点击"开始静音处理"按钮，工具将自动移除视频中的所有音频轨道。</p>
              </div>
            </div>
            <div class="flex items-start">
              ...
              <div>
                ...
                <p>处理完成后，点击"下载视频"即可保存静音后的视频文件。</p>
              </div>
            </div>
          </div>
