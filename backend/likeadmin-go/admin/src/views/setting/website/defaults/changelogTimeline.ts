...
const defaultChangelogTimeline = [
    {
        ...
        badgeText: '稳定性与体验',
        badgeType: 'success',
        title: '工具体验、后台运营与部署链路持续完善',
        features: [
            {
                title: '高频工具体验优化',
                points: [
                    '应用图标生成器优化实时预览性能，缓存图片解码、合并连续渲染，并修复 ICO 导出与下载兼容问题。',
                    '相关推荐统一限制为最多 8 个，主站推荐区与工具页右侧栏保持一致，减少页面滚动负担。',
                    '视频压缩支持更大的单文件处理范围，并补齐大文件提示、会员策略和结果反馈。'
                ]
            },
            {
                title: '前后台配置与内容运营',
                points: [
                    '工具 SEO 与 GEO 字段支持批量维护，工具详情页可生成更完整的搜索摘要、问题与答案结构化内容。',
                    '后台工作台、前端布局、工具主数据和菜单配置补充预览、体检、保存回读与未保存提示，降低运营误操作。',
                    '文案、热榜和站点公共配置继续统一通过服务层与 Go API 网关读取，失败时提供降级内容。'
                ]
            },
            {
                title: '安全与发布稳定性',
                points: [
                    '完善图片代理、外部请求和生产配置检查，减少不安全直连与部署配置遗漏。',
                    '新增 3.0.3 宝塔全栈部署说明，主站、管理端和 Go API 支持同域发布与健康检查。',
                    '类型检查、单元测试、构建检查、工具路由完整性和后台关键操作冒烟均纳入发布前验证。'
                ]
            }
        ]
    },
    {
        ...
        badgeText: '全栈开源',
        badgeType: 'success',
        title: '主站、Go API 与 Arco Pro 管理后台全面开源',
        features: [
            {
                title: '开源策略升级',
                points: [
            ...
            },
            {
                title: '新增 Go 后台与运营能力',
                points: [
                    '新增基于 likeadmin-go 的 Go API 与 Arco Pro 管理端，统一提供菜单权限、站点配置、SEO、工具主数据、用户和系统运维入口。',
                    '前端布局、头部、侧栏、页脚、更新记录、每日学习与工具策略均可由后台配置，并增加保存回读校验和明确的成功/失败提示。',
                    '生产部署统一为主站 <code>/</code>、管理端 <code>/admin/</code> 与 API <code>/api/</code> 同域运行，附带数据库补丁和宝塔更新脚本。'
                ]
            },
            {
                title: '前台体验与内容运营',
                points: [
                    ...
                    '视频压缩、GIF 压缩与 20 个高价值工具补齐结果反馈、失败兜底、复制/下载和移动端体验。'
                ]
            },
            {
                title: '工具与 AI 能力',
                points: [
                    ...
                    '新增 <strong>免费在线 .9 图生成器</strong>，支持 Android Nine-patch 拉伸区、内容安全区可视化标记、透明边缘修剪、实时预览与标准 <code>.9.png</code> 导出。',
                    '抠图移除大体积本地模型，改为后端安全代理第三方 API；密钥仅在后台配置，不暴露给浏览器。',
                    'AI 简历源码保留独立构建能力，正式环境可按需启用，不影响主站与 Go 后台部署。'
                ]
            },
            {
            ...
            },
            {
                ...
                points: [
                    ...
                    '版本继续保持 <strong>3.0.1</strong>，本轮优先保证开源可运行、配置可回环、部署可复现和核心工具稳定。'
                ]
            }
        ]
    },
    {
        ...
        badgeText: '架构演进',
        badgeType: 'info',
        title: '从纯前端工具箱开始建设后台运营能力',
        features: [
            {
                title: '阶段性策略',
                points: [
                    '3.0.0 开始验证前后台分离、站点配置和模型管理能力，为全栈运营奠定基础。',
                    '该阶段曾计划拆分开源版与商业版；3.0.1 已取消分岔，并将新增后台能力一并开源。',
                    '历史版本继续保留，建议新部署直接使用 3.0.1 全栈开源版。'
                ]
            },
            {
                title: '本次同步内容',
    ...
    },
    {
        ...
        features: [
            ...
            {
                title: '工具总数更新',
                points: ['工具总数从227个增加到240个，AI写作工具分类已达15个。']
            }
        ]
    },
    {
        ...
        features: [
            ...
            {
                title: '分类优化',
                points: ['新增<strong>AI写作工具</strong>分类，整合写作类AI应用。']
            }
        ]
    },
    {
    ...
    },
    {
        ...
        features: [
            ...
            },
            {
                ...
                points: ['修复 CSS 构建错误，优化思考动画与代码块样式。']
            }
        ]
    },
    {
    ...
    },
    {
        ...
        features: [
            ...
            {
                title: '交互体验提升',
                points: ['优化卡片悬停效果', '改进分类标签的展示方式', '提升整体页面的流畅度']
            }
        ]
    },
    {
    ...
    },
    {
        ...
        features: [
            ...
            {
                title: '新增爱情公寓一言工具',
                points: ['自动获取爱情公寓经典台词', '优雅的打字机展示效果', '一键复制分享功能']
            }
        ]
    },
    {
    ...
    },
    {
        ...
        features: [
            ...
            {
                title: '搜索功能优化',
                points: ['修复工具搜索结果的跳转问题', '优化搜索结果的展示效果', '改进搜索交互体验']
            }
        ]
    },
    {
