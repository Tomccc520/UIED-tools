...
export const ADMIN_P0_ACTION_PAGES = [
    ...
    },
    {
        ...
        file: 'src/views/operation/advertising/index.vue',
        markers: ['advertising-preview', 'advertising-health-check', 'advertising-banner-add', 'advertising-save'],
        safeClickMarkers: ['advertising-health-check'],
    },
    {
        name: 'AI 抠图 API',
